...
dht DHT;
#define BUFF_MAX 128
#define DHT11_PIN 7 //original is 13
// Create digital PIR sensor instance on D2 pin
DigitalSensor pir(12);
...
//  Serial.print("Temperature = ");
  ...
  //Serial.print(",");
  //Serial1.print(DHT.temperature);//s1
  //Serial1.print(",");//s1
  post_text = String(DHT.temperature)+",";
  //lcd.print(DHT.temperature);
  //lcd.print(",");
  
//  Serial.print("Humidity = ");
  //Serial.println(DHT.humidity);
  //Serial1.print(DHT.humidity);//s1
  //Serial1.print(",");//s1
  post_text = post_text + String(DHT.humidity)+",";
  ...
  //Serial1.print(",");//s1
  int soundSenData = analogRead(soundSensor);
  //Serial.println(soundSenData,DEC);
  //Serial1.print(soundSenData,DEC);//s1
  //Serial1.print(",");//s1
  //Serial1.print(analogRead(gasPin));//s1
  //Serial1.println("T");
  post_text = post_text + String(soundSenData) + "," +String(analogRead(gasPin))+"T";
  if (DHT.temperature > 0 && DHT.humidity > 0) {
    Serial1.println(post_text);
    delay(100); 
  }
}
